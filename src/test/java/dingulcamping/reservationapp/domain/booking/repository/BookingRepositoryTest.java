...
class BookingRepositoryTest {
    ...
    public void before(){
        ...
        Booking booking=new Booking(2000,startDate,endDate,3,room1,findMember.get());
        Booking booking2=new Booking(2000,startDate2,endDate2,3,room2,findMember.get());
        Booking booking3=new Booking(2000,startDate3,endDate3,3,room1,findMember.get());
        Booking booking4=new Booking(2000,startDate,endDate,3,room2,findMember.get());
